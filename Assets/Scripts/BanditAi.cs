...
public class BanditAi : MonoBehaviour
{
    ...
    public float speedWalk = 4;                     //  Walking speed, speed in the nav mesh agent
    public float speedRun = 7;                      //  Running speed

    public float viewRadius = 12;                   //  Radius of the enemy view
    public float attackRadius = 3;                   //  Radius of enemy attack range
